...
import com.example.demo.cart.config.AppConfig;
...
public class UserServiceImpl implements UserService {
    ...
    UserServiceImpl(OrderItemRepository orderItemRepository, AppConfig appConfig) {
	...
	@Override
	public List<FavoriteUserDTO> getFavoriteUserDTOs(Long productId) throws ProductNotFoundException {
